...
const router = createRouter({
    ...
    routes: [
        ...
        { path: '/builder-deck/:slug_play_style/:slug', component: () => import('./pages/DeckBuilder/DeckBuilderDetail.vue'), meta: {requiresAuth: true} },
        { path: '/builder-deck/:slug_play_style/:slug/edit', component: () => import('./pages/DeckBuilder/CreateDeckBuilder.vue'), meta: {requiresAuth: true} },

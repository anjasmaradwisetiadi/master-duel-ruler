...
Route::get('/builder-deck/{slug-play-style}/{DeckBuilders:slug}/edit', [DashboardController::class, 'index']);
Route::get('/builder-deck/{slug-play-style}/create', [DashboardController::class, 'index']);

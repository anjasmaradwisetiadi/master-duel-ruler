...
const router = createRouter({
    ...
    routes: [
        ...
        { path: '/builder-deck/:slug/edit', component: () => import('./pages/DeckBuilder/CreateDeckBuilder.vue'), meta: {requiresAuth: true} },
        { path: '/builder-deck/create', component: () => import('./pages/DeckBuilder/CreateDeckBuilder.vue'), meta: {requiresAuth: true} },
